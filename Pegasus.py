...
kk = LINETCR.LINE() # Assist
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() # Assist
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() # Assist
ks.login(qr=True)
ks.loginResult()

ka = LINETCR.LINE() # Assist
ka.login(qr=True)
ka.loginResult()
...
admin=["u4b0e00ae8e366fc33d645ac5de9acfcf"]
...
#--------------------------------------------------------
		...
		gid = cl.getGroupIdsJoined()
		for i in gid:
		    kk.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n")
		kk.sendText(msg.to,"Success BC BosQ")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
#--------------------------------------------------------
	    elif msg.text in ["Likeon","Self like"]:
		try:
		    print "activity"
